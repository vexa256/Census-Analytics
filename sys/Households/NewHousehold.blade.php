    ...
    <div class="modal-dialog modal-dialog-scrollable modal-fullscreen">
        <div class="modal-content">
            <div class="modal-header bg-gray">
                <h5 class="modal-title"> Let's add a new household to our
                    database
                </h5>
            ...
            <div class="modal-body ">
                ...
                <form action="{{ route('NewHousehold') }}"
                    ...
                    <div class="row">
                        ...
                        <div class="mt-3  mb-3 col-md-6  ">
                            <label id="label" for=""
                                class=" required form-label">Select the Village
                                Where the Household Belongs</label>
